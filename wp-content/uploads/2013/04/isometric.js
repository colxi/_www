...
tileset.src			= "http://www.colxi.info/wp-content/uploads/2013/04/part4_tileset.png";
...
document.getElementById('exportbut').onclick = function(){
	document.getElementById('export').value = JSON.stringify(tile_map)
}

document.getElementById('importbut').onclick = function(){
	tile_map = JSON.parse(document.getElementById('export').value)
}
